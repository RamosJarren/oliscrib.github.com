...
$image_column = 'image'; // e.g., 'product_image' or 'image'
...
if(mysqli_num_rows($result) > 0){
    ...
    while($row = mysqli_fetch_array($result)){
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="'.$img_id.'Label">Product Image</h5>
        ...
        if (!empty($img_file) && $img_file !== '.' && $img_file !== '..') {
            echo '<img src="'.$img_url.'" alt="Product Image" class="img-fluid" style="max-height:400px;" 
        ...
        echo '        </div>
            ...
            <td>
                <a href="./?page=items_edit&id='.$row['id'].'" class="btn btn-warning btnedit" id="btnedit">Edit</a>
            </td>
            </tr>';
    }
    echo '</tbody></table>';
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>4.5.2/js/bootstrap.min.js"></script>4.5.2/js/bootstrap.min.js"></script>4.5.2/js/bootstrap.min.js"></script>