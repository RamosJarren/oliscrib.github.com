        	...
        	<form id="frmsearchprod">
				<table class="table-borderless w-100">
					<tr>
						...
						<td width="125"><button type="button" class="btn btn-success" id="btnaddS">Add Products</button></td>
					</tr>
				</table>
            </form>
        	<div id="contS"></div>
...
$(document).ready(function(){
    ...
    function LoadProduct(pageNum){
        $.post("modules/products_list.php", {
            pagenum: pageNum,
            txtsearch: $("input[name='txtsearch']").val()
        }, function(productData) {
            $("#contS").html(productData);
            history.pushState(null, '', '?page=items&pagenum=' + pageNum + '&txtsearch=' + encodeURIComponent($("input[name='txtsearch']").val()));
        }).fail(function() {
	...
	$("#btnaddS").click(function(){
		document.location = "./?page=items_add";
	});
});
</script>